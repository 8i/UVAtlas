...
typedef std::function<HRESULT JNT_CDECL(float percentComplete)> LPISOCHARTCALLBACK;
typedef std::function<HRESULT JNT_CDECL(const DirectX::XMFLOAT2 *uv, size_t primitiveID, size_t signalDimension, void* userData, float* signalOut)> LPIMTSIGNALCALLBACK;
